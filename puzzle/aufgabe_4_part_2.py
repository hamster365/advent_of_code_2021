...
if __name__ == '__main__':
    ...
    for count in range(100):
        ...
        while list1 and list2 and list3 and list4 and list5 and list6 and list7 and list8 and list9 and list10 != []:
        ...
        if max_count is not None:
            if total_count >= max_count:
                ...
                final_list = list1
                final_list = final_list + list(set(list2) - set(final_list))
                ...
                print(count)
                score = score * numbers[total_count]
                print(score)
        else:
            max_count = counter
        count += 1
